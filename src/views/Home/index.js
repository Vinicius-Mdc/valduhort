      ...
      <Wrapper>
        <SwiperContainer>
          ...
          >
            <SwiperSlide>
              <SwiperLink href="#">
                <SwiperImage src="https://cdn.awsli.com.br/1140x1140/305/305913/banner/e700e9b5b5.jpg" />
              </SwiperLink>
            </SwiperSlide>
            <SwiperSlide>
              <SwiperLink href="#">
                <SwiperImage src="https://cdn.awsli.com.br/1140x1140/305/305913/banner/1125b8ae4f.jpg" />
              </SwiperLink>
            </SwiperSlide>
            <SwiperSlide>
              <SwiperLink href="#">
                <SwiperImage src="https://cdn.awsli.com.br/1140x1140/305/305913/banner/2735761ee3.jpg" />
              </SwiperLink>
            </SwiperSlide>
          </Swiper>
        </SwiperContainer>
        <StoreInfo>
          <StoreIcons>
            <StoreDetail>
              ...
              <IconText>Preços que cabem no seu bolso</IconText>
            </StoreDetail>
            <StoreDetail>
              <Icon
                viewBox="0 0 135 135"
              ...
              <IconText>Pronta entrega às Sextas Feiras</IconText>
            </StoreDetail>
            <StoreDetail>
              <Icon
                viewBox="0 0 135 135"
              ...
              <IconText>Produtos de alta qualidade</IconText>
            </StoreDetail>
          </StoreIcons>
          <SeeProductsWrapper>
            <SeeProducts to="/products">Ver Produtos</SeeProducts>
          </SeeProductsWrapper>
        </StoreInfo>
